...
//Iss ka matlab string se integer pe convert karne ke liye (+ lagate hein
...
else if(percentage_of_marks >= 70 && percentage_of_marks < 80) {
    document.write("Grade: A");
    document.write("<br>");
    document.write("Remarks: Good");
}
else if(percentage_of_marks >= 60 && percentage_of_marks < 70) {
